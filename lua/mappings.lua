...
map("n", "<leader>dp", require("dap").continue, { desc = "DAP Continue" })
...
map("n", "<leader>dc", require("dapui").close, { desc = "DAP Close window" })
...
map("n", "<leader>fq", require("telescope.builtin").resume, { desc = "Telescope Resume" })
map("v", "<leader>fg", require("telescope.builtin").grep_string, { desc = "Telescope Grep String" })
-- live grep in a specific directory
map("n", "<leader>fa", function()
  require("telescope.builtin").live_grep { prompt_title = "Live Grep in Git", search_dirs = { "/home/ev/git" } }
